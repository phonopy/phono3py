...
def test_cutoff_fc3_zero(nacl_pbe: Phono3py):
    ...
    print(abs_delta)
    assert np.abs(5259.22341634 - abs_delta) < 1e-3
...
def test_fc3(si_pbesol_111: Phono3py):
    ...
    fc3_ref = [
        [
            [0.10725082233070934, 0.0, 0.0],
            [0.00896414569270576, -0.14304691148751034, -0.138498937450608],
            [-0.00896414569270576, -0.138498937450608, -0.14304691148751034],
        ],
        [
            [-0.00896414569270576, -0.1430469114875104, -0.13849893745060804],
            [-0.03394571572680041, 0.0, 0.0],
            [-0.331746167221262, -0.02600257244115759, -0.02600257244115759],
        ],
        [
            [0.00896414569270576, -0.138498937450608, -0.14304691148751034],
            [-0.331746167221262, 0.0260025724411576, 0.02600257244115759],
            [-0.03394571572680041, 0.0, 0.0],
        ],
    ]
    assert ph.fc3 is not None
